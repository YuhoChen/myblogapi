...
{
    private $accessKey = "-0ZUMHORfo2SicjhTjRheY2jnAlhXBL7hl7LF7uV";
    private $secretKey = "ZhB2GMbWKMJfcLPpYkzbFtMWPfzONyHd1MRbQtR0";
    ...
    public function get_upload_token($bucket, $withWater, $token)
    {
        ...
        $args['returnBody'] = '{"imgUrl": "http://pn9knz15f.bkt.clouddn.com/$(key)"}'; // 这里要改成自己的域名或其他，上传成功后是返回这个json数据，url就是图片的地址
        $b = json_encode($args);
        $result = array(
